...
# np.savetxt("processed_train.csv",train_data,fmt='%.2e',delimiter=',');
# np.savetxt("processed_valid.csv",valid_data,fmt='%.2e',delimiter=',');
# np.savetxt("processed_test.csv",test_data,fmt='%.2e',delimiter=',');
